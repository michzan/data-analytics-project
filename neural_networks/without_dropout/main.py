...
if __name__ == '__main__':
    ...
    for hidden_sizes_1, hidden_sizes_2,num_epochs, batch in hyperparameters:
        log_name = "dim1" + str(hidden_sizes_1) + "dim2" + str(hidden_sizes_2) + "ep" + str(num_epochs) + "bs" + str(batch) + "lr" + str(learning_rate)
        ...
        if not os.path.exists('models'):
            os.makedirs('models')
        torch.save(mlp.state_dict(), 'models/' + log_name)
    ...
    torch.save(best_mlp.state_dict(), 'best_models/' + log_name_b)
