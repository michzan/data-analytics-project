...
if __name__ == '__main__':
    ...
    for hidden_sizes_1, hidden_sizes_2,num_epochs, batch, depth in hyperparameters:
        ...
        if not os.path.exists('/content/drive/MyDrive/01-DataAnalitycs/Progetto/neural_networks/models_dropout'):
            os.makedirs('/content/drive/MyDrive/01-DataAnalitycs/Progetto/neural_networks/models_dropout')
        torch.save(mlp.state_dict(), '/content/drive/MyDrive/01-DataAnalitycs/Progetto/neural_networks/models_dropout/' + log_name)
    ...
    #salva modello best
    if not os.path.exists('/content/drive/MyDrive/01-DataAnalitycs/Progetto/neural_networks/best_models_dropout'):
            os.makedirs('/content/drive/MyDrive/01-DataAnalitycs/Progetto/neural_networks/best_models_dropout')
    torch.save(best_mlp.state_dict(), '/content/drive/MyDrive/01-DataAnalitycs/Progetto/neural_networks/best_models_dropout/' + log_name_b)
